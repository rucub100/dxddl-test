...
public final class DirectTestChunk2 implements AutoCloseable {
    ...
    private static final int OFFSET_I = 24;
    private static final int OFFSET_L = 28;
    ...
    public static int getI(final long p_id) {
        ...
        return RAWREAD.readInt(addr, OFFSET_I);
    }
    ...
    public static void setI(final long p_id, final int p_i) {
        ...
        RAWWRITE.writeInt(addr, OFFSET_I, p_i);
    }
    ...
    private DirectTestChunk2() {}

    public static DirectTestChunk2 use(final long p_id) {
        long addr;
        ...
        DirectTestChunk2 tmp = new DirectTestChunk2();
        tmp.m_addr = addr;
        return tmp;
    }
    ...
    public int getI() {
        ...
        return RAWREAD.readInt(m_addr, OFFSET_I);
    }
    ...
    public void setI(final int p_i) {
        ...
        RAWWRITE.writeInt(m_addr, OFFSET_I, p_i);
    }
