...
public final class DirectTestChunk3 implements AutoCloseable {
    ...
    private static final int OFFSET_B2_LENGTH = 28;
    private static final int OFFSET_B2_CID = 32;
    private static final int OFFSET_B2_ADDR = 40;
    private static final int OFFSET_C_LENGTH = 48;
    private static final int OFFSET_C_CID = 52;
    private static final int OFFSET_C_ADDR = 60;
    private static final int OFFSET_D_LENGTH = 68;
    private static final int OFFSET_D_CID = 72;
    private static final int OFFSET_D_ADDR = 80;
    private static final int OFFSET_F_LENGTH = 88;
    private static final int OFFSET_F_CID = 92;
    private static final int OFFSET_F_ADDR = 100;
    private static final int OFFSET_I_LENGTH = 108;
    private static final int OFFSET_I_CID = 112;
    private static final int OFFSET_I_ADDR = 120;
    private static final int OFFSET_L_LENGTH = 128;
    private static final int OFFSET_L_CID = 132;
    private static final int OFFSET_L_ADDR = 140;
    private static final int OFFSET_S_LENGTH = 148;
    private static final int OFFSET_S_CID = 152;
    private static final int OFFSET_S_ADDR = 160;
    ...
    public static long create() {
        ...
        RAWWRITE.writeLong(addr, OFFSET_B2_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_C_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_D_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_F_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_I_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_L_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeLong(addr, OFFSET_S_CID, 0xFFFFFFFFFFFFFFFFL);
        RAWWRITE.writeInt(addr, OFFSET_B_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_B2_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_C_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_D_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_F_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_I_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_L_LENGTH, 0);
        RAWWRITE.writeInt(addr, OFFSET_S_LENGTH, 0);
        RAWWRITE.writeLong(addr, OFFSET_B_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_B2_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_C_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_D_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_F_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_I_ADDR, 0x0L);
        RAWWRITE.writeLong(addr, OFFSET_L_ADDR, 0x0L);
    ...
    public static void remove(final long p_id) {
        ...
        final long cid_OFFSET_B2_CID = RAWREAD.readLong(addr, OFFSET_B2_CID);
        PINNING.unpinCID(cid_OFFSET_B2_CID);
        REMOVE.remove(cid_OFFSET_B2_CID);
        final long cid_OFFSET_C_CID = RAWREAD.readLong(addr, OFFSET_C_CID);
        ...
        final long cid_OFFSET_F_CID = RAWREAD.readLong(addr, OFFSET_F_CID);
        PINNING.unpinCID(cid_OFFSET_F_CID);
        REMOVE.remove(cid_OFFSET_F_CID);
        ...
        final long cid_OFFSET_L_CID = RAWREAD.readLong(addr, OFFSET_L_CID);
        PINNING.unpinCID(cid_OFFSET_L_CID);
        REMOVE.remove(cid_OFFSET_L_CID);
    ...
    public static boolean getB(final long p_id, final int index) {
        long addr;
        ...
        return RAWREAD.readBoolean(addr2, (1 * index));
    }
    ...
    public static boolean[] getB(final long p_id) {
        ...
        return RAWREAD.readBooleanArray(RAWREAD.readLong(addr, OFFSET_B_ADDR), 0, len);
    }

    public static void setB(final long p_id, final int index, final boolean value) {
        long addr;
        ...
        final long addr2 = RAWREAD.readLong(addr, OFFSET_B_ADDR);
        RAWWRITE.writeBoolean(addr2, (1 * index), value);
    }
    ...
    public static void setB(final long p_id, final boolean[] p_b) {
        ...
        RAWWRITE.writeBooleanArray(addr2, 0, p_b);
    }

    public static int getB2Length(final long p_id) {
        long addr;
        ...
        return RAWREAD.readInt(addr, OFFSET_B2_LENGTH);
    }

    public static byte getB2(final long p_id, final int index) {
        long addr;
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_B2_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr2 = RAWREAD.readLong(addr, OFFSET_B2_ADDR);
    ...
    public static byte[] getB2(final long p_id) {
        ...
        return RAWREAD.readByteArray(RAWREAD.readLong(addr, OFFSET_B2_ADDR), 0, len);
    }

    public static void setB2(final long p_id, final int index, final byte value) {
        long addr;
    ...
    public static void setB2(final long p_id, final byte[] p_b2) {
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_B2_LENGTH);
        final long array_cid = RAWREAD.readLong(addr, OFFSET_B2_CID);
        ...
        if (p_b2 == null || p_b2.length == 0) {
            return;
        }

        final long[] new_cid = new long[1];
        CREATE.create(new_cid, 1, (1 * p_b2.length));
        final long addr2 = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(addr, OFFSET_B2_CID, new_cid[0]);
        RAWWRITE.writeLong(addr, OFFSET_B2_ADDR, addr2);
        RAWWRITE.writeInt(addr, OFFSET_B2_LENGTH, p_b2.length);
        RAWWRITE.writeByteArray(addr2, 0, p_b2);
    }
    ...
    public static int getCLength(final long p_id) {
        ...
        return RAWREAD.readInt(addr, OFFSET_C_LENGTH);
    }

    public static char getC(final long p_id, final int index) {
        long addr;
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_C_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr2 = RAWREAD.readLong(addr, OFFSET_C_ADDR);
    ...
    public static char[] getC(final long p_id) {
        ...
        return RAWREAD.readCharArray(RAWREAD.readLong(addr, OFFSET_C_ADDR), 0, len);
    }

    public static void setC(final long p_id, final int index, final char value) {
        long addr;
    ...
    public static void setC(final long p_id, final char[] p_c) {
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_C_LENGTH);
        final long array_cid = RAWREAD.readLong(addr, OFFSET_C_CID);
        ...
        final long addr2 = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(addr, OFFSET_C_CID, new_cid[0]);
        RAWWRITE.writeLong(addr, OFFSET_C_ADDR, addr2);
        RAWWRITE.writeInt(addr, OFFSET_C_LENGTH, p_c.length);
    ...
    public static int getFLength(final long p_id) {
        long addr;
        ...
        return RAWREAD.readInt(addr, OFFSET_F_LENGTH);
    }

    public static float getF(final long p_id, final int index) {
        long addr;
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_F_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr2 = RAWREAD.readLong(addr, OFFSET_F_ADDR);
        return RAWREAD.readFloat(addr2, (4 * index));
    }
    ...
    public static float[] getF(final long p_id) {
        ...
        return RAWREAD.readFloatArray(RAWREAD.readLong(addr, OFFSET_F_ADDR), 0, len);
    }

    public static void setF(final long p_id, final int index, final float value) {
        long addr;
        ...
        final long addr2 = RAWREAD.readLong(addr, OFFSET_F_ADDR);
        RAWWRITE.writeFloat(addr2, (4 * index), value);
    }
    ...
    public static void setF(final long p_id, final float[] p_f) {
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_F_LENGTH);
        final long array_cid = RAWREAD.readLong(addr, OFFSET_F_CID);
        ...
        if (p_f == null || p_f.length == 0) {
            return;
        }

        final long[] new_cid = new long[1];
        CREATE.create(new_cid, 1, (4 * p_f.length));
        final long addr2 = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(addr, OFFSET_F_CID, new_cid[0]);
        RAWWRITE.writeLong(addr, OFFSET_F_ADDR, addr2);
        RAWWRITE.writeInt(addr, OFFSET_F_LENGTH, p_f.length);
        RAWWRITE.writeFloatArray(addr2, 0, p_f);
    }
    ...
    public static int getLLength(final long p_id) {
        long addr;
        ...
        return RAWREAD.readInt(addr, OFFSET_L_LENGTH);
    }

    public static long getL(final long p_id, final int index) {
        long addr;
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_L_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr2 = RAWREAD.readLong(addr, OFFSET_L_ADDR);
    ...
    public static long[] getL(final long p_id) {
        ...
        return RAWREAD.readLongArray(RAWREAD.readLong(addr, OFFSET_L_ADDR), 0, len);
    }

    public static void setL(final long p_id, final int index, final long value) {
        long addr;
    ...
    public static void setL(final long p_id, final long[] p_l) {
        ...
        final int len = RAWREAD.readInt(addr, OFFSET_L_LENGTH);
        final long array_cid = RAWREAD.readLong(addr, OFFSET_L_CID);
        ...
        if (p_l == null || p_l.length == 0) {
            return;
        }

        final long[] new_cid = new long[1];
        CREATE.create(new_cid, 1, (8 * p_l.length));
        final long addr2 = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(addr, OFFSET_L_CID, new_cid[0]);
        RAWWRITE.writeLong(addr, OFFSET_L_ADDR, addr2);
        RAWWRITE.writeInt(addr, OFFSET_L_LENGTH, p_l.length);
        RAWWRITE.writeLongArray(addr2, 0, p_l);
    }
    ...
    private DirectTestChunk3() {}

    public static DirectTestChunk3 use(final long p_id) {
        long addr;
        ...
        DirectTestChunk3 tmp = new DirectTestChunk3();
        tmp.m_addr = addr;
        return tmp;
    }
    ...
    public boolean getB(final int index) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
        ...
        return RAWREAD.readBoolean(addr, (1 * index));
    }
    ...
    public boolean[] getB() {
        ...
        return RAWREAD.readBooleanArray(RAWREAD.readLong(m_addr, OFFSET_B_ADDR), 0, len);
    }

    public void setB(final int index, final boolean value) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
        ...
        final long addr = RAWREAD.readLong(m_addr, OFFSET_B_ADDR);
        RAWWRITE.writeBoolean(addr, (1 * index), value);
    }
    ...
    public void setB(final boolean[] p_b) {
        ...
        RAWWRITE.writeBooleanArray(addr, 0, p_b);
    }

    public int getB2Length() {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }

        return RAWREAD.readInt(m_addr, OFFSET_B2_LENGTH);
    }

    public byte getB2(final int index) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }

        final int len = RAWREAD.readInt(m_addr, OFFSET_B2_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr = RAWREAD.readLong(m_addr, OFFSET_B2_ADDR);
    ...
    public byte[] getB2() {
        ...
        return RAWREAD.readByteArray(RAWREAD.readLong(m_addr, OFFSET_B2_ADDR), 0, len);
    }

    public void setB2(final int index, final byte value) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
    ...
    public void setB2(final byte[] p_b2) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_B2_LENGTH);
        final long cid = RAWREAD.readLong(m_addr, OFFSET_B2_CID);

        if (cid != 0xFFFFFFFFFFFFFFFFL) {
            PINNING.unpinCID(cid);
            REMOVE.remove(cid);
            RAWWRITE.writeLong(m_addr, OFFSET_B2_CID, 0xFFFFFFFFFFFFFFFFL);
            RAWWRITE.writeLong(m_addr, OFFSET_B2_ADDR, 0x0L);
            RAWWRITE.writeInt(m_addr, OFFSET_B2_LENGTH, 0);
        }
        ...
        CREATE.create(new_cid, 1, (1 * p_b2.length));
        final long addr = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(m_addr, OFFSET_B2_CID, new_cid[0]);
        RAWWRITE.writeLong(m_addr, OFFSET_B2_ADDR, addr);
        RAWWRITE.writeInt(m_addr, OFFSET_B2_LENGTH, p_b2.length);
        RAWWRITE.writeByteArray(addr, 0, p_b2);
    }
    ...
    public int getCLength() {
        ...
        return RAWREAD.readInt(m_addr, OFFSET_C_LENGTH);
    }
    ...
    public char getC(final int index) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_C_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr = RAWREAD.readLong(m_addr, OFFSET_C_ADDR);
        return RAWREAD.readChar(addr, (2 * index));
    }
    ...
    public char[] getC() {
        ...
        return RAWREAD.readCharArray(RAWREAD.readLong(m_addr, OFFSET_C_ADDR), 0, len);
    }

    public void setC(final int index, final char value) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
        ...
        final long addr = RAWREAD.readLong(m_addr, OFFSET_C_ADDR);
        RAWWRITE.writeChar(addr, (2 * index), value);
    }
    ...
    public void setC(final char[] p_c) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_C_LENGTH);
        final long cid = RAWREAD.readLong(m_addr, OFFSET_C_CID);

        if (cid != 0xFFFFFFFFFFFFFFFFL) {
            PINNING.unpinCID(cid);
            REMOVE.remove(cid);
            RAWWRITE.writeLong(m_addr, OFFSET_C_CID, 0xFFFFFFFFFFFFFFFFL);
            RAWWRITE.writeLong(m_addr, OFFSET_C_ADDR, 0x0L);
            RAWWRITE.writeInt(m_addr, OFFSET_C_LENGTH, 0);
        }
        ...
        CREATE.create(new_cid, 1, (2 * p_c.length));
        final long addr = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(m_addr, OFFSET_C_CID, new_cid[0]);
        RAWWRITE.writeLong(m_addr, OFFSET_C_ADDR, addr);
        RAWWRITE.writeInt(m_addr, OFFSET_C_LENGTH, p_c.length);
        RAWWRITE.writeCharArray(addr, 0, p_c);
    }
    ...
    public int getFLength() {
        ...
        return RAWREAD.readInt(m_addr, OFFSET_F_LENGTH);
    }
    ...
    public float getF(final int index) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_F_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr = RAWREAD.readLong(m_addr, OFFSET_F_ADDR);
        return RAWREAD.readFloat(addr, (4 * index));
    }
    ...
    public float[] getF() {
        ...
        return RAWREAD.readFloatArray(RAWREAD.readLong(m_addr, OFFSET_F_ADDR), 0, len);
    }

    public void setF(final int index, final float value) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
        ...
        final long addr = RAWREAD.readLong(m_addr, OFFSET_F_ADDR);
        RAWWRITE.writeFloat(addr, (4 * index), value);
    }
    ...
    public void setF(final float[] p_f) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_F_LENGTH);
        final long cid = RAWREAD.readLong(m_addr, OFFSET_F_CID);

        if (cid != 0xFFFFFFFFFFFFFFFFL) {
            PINNING.unpinCID(cid);
            REMOVE.remove(cid);
            RAWWRITE.writeLong(m_addr, OFFSET_F_CID, 0xFFFFFFFFFFFFFFFFL);
            RAWWRITE.writeLong(m_addr, OFFSET_F_ADDR, 0x0L);
            RAWWRITE.writeInt(m_addr, OFFSET_F_LENGTH, 0);
        }
        ...
        CREATE.create(new_cid, 1, (4 * p_f.length));
        final long addr = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(m_addr, OFFSET_F_CID, new_cid[0]);
        RAWWRITE.writeLong(m_addr, OFFSET_F_ADDR, addr);
        RAWWRITE.writeInt(m_addr, OFFSET_F_LENGTH, p_f.length);
        RAWWRITE.writeFloatArray(addr, 0, p_f);
    }
    ...
    public int getLLength() {
        ...
        return RAWREAD.readInt(m_addr, OFFSET_L_LENGTH);
    }
    ...
    public long getL(final int index) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_L_LENGTH);

        if (index < 0 || index >= len) {
            throw new ArrayIndexOutOfBoundsException();
        }

        final long addr = RAWREAD.readLong(m_addr, OFFSET_L_ADDR);
    ...
    public long[] getL() {
        ...
        return RAWREAD.readLongArray(RAWREAD.readLong(m_addr, OFFSET_L_ADDR), 0, len);
    }

    public void setL(final int index, final long value) {
        if (!INITIALIZED) {
            throw new RuntimeException("Not initialized!");
        }
    ...
    public void setL(final long[] p_l) {
        ...
        final int len = RAWREAD.readInt(m_addr, OFFSET_L_LENGTH);
        final long cid = RAWREAD.readLong(m_addr, OFFSET_L_CID);

        if (cid != 0xFFFFFFFFFFFFFFFFL) {
            PINNING.unpinCID(cid);
            REMOVE.remove(cid);
            RAWWRITE.writeLong(m_addr, OFFSET_L_CID, 0xFFFFFFFFFFFFFFFFL);
            RAWWRITE.writeLong(m_addr, OFFSET_L_ADDR, 0x0L);
            RAWWRITE.writeInt(m_addr, OFFSET_L_LENGTH, 0);
        }
        ...
        CREATE.create(new_cid, 1, (8 * p_l.length));
        final long addr = PINNING.pin(new_cid[0]).getAddress();
        RAWWRITE.writeLong(m_addr, OFFSET_L_CID, new_cid[0]);
        RAWWRITE.writeLong(m_addr, OFFSET_L_ADDR, addr);
        RAWWRITE.writeInt(m_addr, OFFSET_L_LENGTH, p_l.length);
        RAWWRITE.writeLongArray(addr, 0, p_l);
    }
