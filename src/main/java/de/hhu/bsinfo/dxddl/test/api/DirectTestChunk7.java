...
public final class DirectTestChunk7 implements AutoCloseable {
    ...
    private DirectTestChunk7() {}

    public static DirectTestChunk7 use(final long p_id) {
        long addr;
        ...
        DirectTestChunk7 tmp = new DirectTestChunk7();
        tmp.m_addr = addr;
        return tmp;
    }
