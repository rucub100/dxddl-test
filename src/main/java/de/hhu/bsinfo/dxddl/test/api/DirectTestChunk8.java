...
public final class DirectTestChunk8 implements AutoCloseable {
    ...
    private DirectTestChunk8() {}

    public static DirectTestChunk8 use(final long p_id) {
        long addr;
        ...
        DirectTestChunk8 tmp = new DirectTestChunk8();
        tmp.m_addr = addr;
        return tmp;
    }
