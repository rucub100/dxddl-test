 ...
 *
 */
public final class TestCase1Direct extends AbstractTest {

    private static final Logger LOGGER = LogManager.getFormatterLogger(TestCase1Direct.class);

    public TestCase1Direct(
            String name,
